var locations = [
    ['Rạp Xiếc Trung Ương', "67-69 Trần Nhân Tông, Lê Đại Hành, Hai Bà Trưng, Hà Nội 10000 Vietnam", "$36,000", 21.017288, 105.842027, "property-detail", "assets/img/properties/property-01.jpg", "assets/img/property-types/apartment.png"],
    ['HanoiHub Coworking Space', "Tầng 2, Số 2, Ngõ 59 Láng Hạ, Chợ Dừa, Ba Đình, Hà Nội 10000 Vietnam", "$28,000", 21.017159, 105.816058, "property-detail", "assets/img/properties/property-02.jpg", "assets/img/property-types/apartment.png"],

    ['Bookstore Populist 1', "Nhà Sách Vì Dân 11", "$36,000", 21.015083, 105.810469, "property-detail", "assets/img/properties/property-03.jpg", "assets/img/property-types/construction-site.png"],
    ['Ký túc xá Đại học Giao Thông', "99 Nguyễn Chí Thanh, Láng Hạ, Đống Đa, Hà Nội, Vietnam", "$28,000", 21.016013, 105.810569, "property-detail", "assets/img/properties/property-04.jpg", "assets/img/property-types/cottage.png"],
    ['Ký túc xá Đại học Giao Thông', "99 Nguyễn Chí Thanh, Láng Hạ, Đống Đa, Hà Nội, Vietnam", "$28,000", 21.006260, 105.830940, "property-detail", "assets/img/properties/property-06.jpg", "assets/img/property-types/garage.png"],
